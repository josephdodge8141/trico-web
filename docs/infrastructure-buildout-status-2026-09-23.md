...
- Enable and observe automatic `main` → development → production delivery, then record its exact release SHA and results. The manual production run above does not establish this path.
